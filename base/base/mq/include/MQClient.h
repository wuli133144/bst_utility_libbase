...
#ifndef __MQCLIENT_H__
#define __MQCLIENT_H__
...
class ROCKETMQCLIENT_API MQClient {
  ...
  */
  QueryResult queryMessage(const std::string& topic, const std::string& key,
                           int maxNum, int64 begin, int64 end);

  std::vector<MQMessageQueue> getTopicMessageQueueInfo(
 ...
 **/
  ...
  **/
  ...
  std::string getKVConfig(const std::string& addr,
                          const std::string& projectNamespace,
                          const std::string& key,
                          SessionCredentials& sessionCredentials,
                          int timeoutMillis);
  std::string setKVConfig(const std::string& addr,
                          const std::string& projectNamespace,
                          const std::string& key, const std::string& value,
                          SessionCredentials& sessionCredentials,
                          int timeoutMillis);

  std::string getKVListByNamespace(const std::string& addr,
                                   const std::string& projectNamespace,
                                   SessionCredentials& sessionCredentials,
                                   int timeoutMillis);
