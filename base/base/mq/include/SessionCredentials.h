...
class SessionCredentials {
 public:
  ...
  void setAccessKey(std::string input_accessKey) {
    accessKey = input_accessKey;
  }

  std::string getSecretKey() const { return secretKey; }

  void setSecretKey(std::string input_secretKey) {
    secretKey = input_secretKey;
  }

  std::string getSignature() const { return signature; }

  void setSignature(std::string input_signature) {
  ...
  void setAuthChannel(std::string input_channel) {
    authChannel = input_channel;
  }
