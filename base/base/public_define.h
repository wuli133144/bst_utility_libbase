...
#define CHECK_IDENTITY_TYPE_STUDENT(type) \
({\
bool bRet = false;\
if (IM::BaseDefine::CLIENT_IDENTITY_STUDENT == type)\
{\
bRet = true;\
}\
bRet;\
...
#define CHECK_IDENTITY_TYPE_TEACHER(type) \
({\
bool bRet = false;\
if ((IM::BaseDefine::CLIENT_IDENTITY_MANAGER == type) || (IM::BaseDefine::CLIENT_IDENTITY_DUTY == type) || (IM::BaseDefine::CLIENT_IDENTITY_COMPLAINT_REFUND == type))\
{\
bRet = true;\
}\
bRet;\
...
#define CHECK_IDENTITY_TYPE_SYSTEM(type) \
({\
bool bRet = false;\
if (IM::BaseDefine::CLIENT_IDENTITY_SYSTEM == type)\
{\
bRet = true;\
}\
bRet;\
...
({\
bool bRet = false;\
if ((IM::BaseDefine::MSG_TYPE_SINGLE_TEXT == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_AUDIO == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_PICTURE == type) \
 || (IM::BaseDefine::MSG_TYPE_SINGLE_FILE == type) || (IM::BaseDefine::MSG_TYPE_SINGLE_VIDEO == type)|| (IM::BaseDefine::MSG_TYPE_SINGLE_SHARE == type))\
{\
bRet = true;\
}\
bRet;\
...
({\
bool bRet = false;\
if ((IM::BaseDefine::MSG_TYPE_GROUP_TEXT == type) || (IM::BaseDefine::MSG_TYPE_GROUP_AUDIO == type) || (IM::BaseDefine::MSG_TYPE_GROUP_PICTURE == type) \
 || (IM::BaseDefine::MSG_TYPE_GROUP_FILE == type) || (IM::BaseDefine::MSG_TYPE_GROUP_VIDEO == type) || (IM::BaseDefine::MSG_TYPE_GROUP_SHARE == type)  \
 || (IM::BaseDefine::MSG_TYPE_GROUP_QRCODE == type) || (IM::BaseDefine::MSG_TYPE_GROUP_MSG_REVOKE == type) || (IM::BaseDefine::MSG_TYPE_GROUP_MSG_SHIELD == type))\
{\
bRet = true;\
}\
bRet;\
